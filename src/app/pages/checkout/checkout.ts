...
export class CheckoutComponent implements OnInit, OnDestroy {
  ...
  private cleanupPayPal(): void {
    ...
    this.paypalButtons = [];
    this.paypalButtonEligible = false; this.cardButtonEligible = false;
