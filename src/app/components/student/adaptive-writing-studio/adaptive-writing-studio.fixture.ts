...
export const DEVELOPMENT_ADAPTIVE_PRACTICE_FIXTURE: readonly AdaptivePracticeActivity[] = [
  {
    ...
    questions: [{ id: 'q1', questionType: 'open_response', task: 'Rewrite the text using linking words to show relationships between ideas.',
  ...
  },
  {
    ...
    questions: [{ id: 'q1', questionType: 'open_response', task: 'Rewrite the text using more specific and academic vocabulary.',
